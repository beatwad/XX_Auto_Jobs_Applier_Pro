...
1. **Institution Name**: Specify the university or educational institution’s name and location.
...
If you find out the location of the institution - also add it to the resume, 
else don't add it and delete the corresponding paragraph (<span class="entry-location">[Location] </span>) from the HTML template.
...
1. **Company Name**: Provide the name of the company.
...
If you find out the location of company - also add it to the resume, 
else don't add it and delete the corresponding paragraph (<span class="entry-location">[Location]</span>) from the HTML template.
